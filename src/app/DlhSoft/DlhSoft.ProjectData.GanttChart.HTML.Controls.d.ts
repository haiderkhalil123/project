...
declare module DlhSoft.Controls {
    ...
    module GanttChartView {
        ...
        function datePickerInputColumnTemplateBase(document: HTMLDocument, width: number, valueGetter: () => any, valueSetter: (value: any) => void, isEnabledGetter?: () => boolean, isVisibleGetter?: () => boolean, isBoldGetter?: () => boolean, defaultTimeOfDay?: number, calendarSelectorLevels?: number, months?: string[], daysOfWeek?: string[], dateTimeFormatter?: (arg0: Date) => string, dateTimeParser?: (arg0: string) => Date): HTMLElement;
        function dateTimePickerInputColumnTemplateBase(document: HTMLDocument, width: number, valueGetter: () => any, valueSetter: (value: any) => void, isEnabledGetter?: () => boolean, isVisibleGetter?: () => boolean, isBoldGetter?: () => boolean, defaultTimeOfDay?: number, calendarSelectorLevels?: number, months?: string[], daysOfWeek?: string[], dateTimeFormatter?: (arg0: Date) => string, dateTimeParser?: (arg0: string) => Date): HTMLElement;
        ...
        interface Element extends HTMLElement {
            ...
            setSplitterPosition(gridWidth: number, chartWidth: number):any;
    ...
    module ScheduleChartView {
        ...
        interface Element extends GanttChartView.Element {
            ...
            moveScheduleChartItem(item: Item, toIndex: number):any;
    ...
    module LoadChartView {
        ...
        interface Element extends ScheduleChartView.Element {
            ...
            moveLoadChartItem(item: Item, toIndex: number):any;
